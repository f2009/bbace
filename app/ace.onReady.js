...
define(['jquery'], function($){
	...
	return {
		...
		enableDemoAjax: enableDemoAjax,
		handleScrollbars: handleScrollbars,
		dropdownAutoPos: dropdownAutoPos,
		navbarHelpers: navbarHelpers,
		sidebarTooltips: sidebarTooltips,
		scrollTopBtn: scrollTopBtn,
		someBrowserFix: someBrowserFix,
		bsCollapseToggle: bsCollapseToggle,
		smallDeviceDropdowns: smallDeviceDropdowns
	}
});
