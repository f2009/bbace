define([
    'tpl!app/home/templates/tab_panel.tpl',
    'tpl!app/home/templates/tab_title.tpl',
    'tpl!app/home/templates/tab_content.tpl',
    'i18n!app_props/nls/text'
], function(tpl, titleTpl, contentTpl, i18nText) {
    ...
    var View = Marionette.LayoutView.extend({
        ...
        addTabContent: function (view) {
            ...
            var tabName = i18nText._(view.tabId);
        ...
        showTabView: function (view, id, tabName) {
            ...
            // 如果页面未加载该view
                ...
                tab = {
                    $tabTitle: $(_.template(titleTpl)({id: id, title: tabName})).appendTo(ui.tabTitle),
                    $tabContent: $(_.template(contentTpl)({id: id})).appendTo(ui.tabContent)
                };
                

                view.render();

                tab.$tabContent.append(view.$el);
